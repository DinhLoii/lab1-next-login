...
const LoginForm = () => {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center p-4 relative overflow-hidden bg-gray-50/50">
            {/* Background Decorations */}
            <div className="absolute top-[-20%] left-[-10%] w-[70%] h-[70%] bg-purple-400/20 rounded-full blur-[120px] animate-pulse" />
            <div className="absolute bottom-[-20%] right-[-10%] w-[70%] h-[70%] bg-indigo-400/20 rounded-full blur-[120px] animate-pulse" />
            ...
            <Card className="w-full max-w-[480px] border-white/20 bg-white/80 backdrop-blur-xl shadow-2xl relative z-10 overflow-hidden transition-all duration-300">
                <div className="absolute top-0 left-0 w-full h-1.5 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600" />
                ...
                <CardContent className="space-y-6 px-8 pb-10">
                    ...
                    <div className="relative py-2">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-4 text-gray-500 bg-white/80 backdrop-blur-sm">
                    ...
                    <div className="space-y-6 pt-2">
                        <p className="text-center text-sm text-gray-600">
                            ...
                            <a href="#" className="text-indigo-600 hover:text-indigo-700 font-bold hover:underline transition-all">
                                Login
                            </a>
                        </p>
                        ...
                        <p className="text-xs text-gray-400 text-center leading-relaxed px-4">
                            ...
                            <a href="/terms" className="text-indigo-600 hover:text-indigo-800 hover:underline cursor-pointer transition-colors">
                                Terms of Service
                            </a>{" "}
                            and{" "}
                            <a href="/privacy" className="text-indigo-600 hover:text-indigo-800 hover:underline cursor-pointer transition-colors">
                                Privacy Policy
                            </a>
                            .
                        </p>
